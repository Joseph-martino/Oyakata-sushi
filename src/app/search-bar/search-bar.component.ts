...
import { Sushi } from '../sushi/models/sushi';
import { SushiService } from '../sushi/service/sushi.service';
...
export class SearchBarComponent implements OnInit{
  ...
  constructor(private menuService: MenuService, private sushiService: SushiService, private router: Router){

  }

  ngOnInit(): void {

    this.isSushiPage = this.router.url.includes("list-sushis");
    this.isMenuPage = this.router.url.includes("list-menus");
    console.log("resultat: " + this.isSushiPage);
    ...
    if(this.isSushiPage){
      ...
      this.sushis$ = this.searchTerms.pipe(
        ...
        //[..."abc"]
        //pour cela, on utiliise l'opérateur SwitchMap
        switchMap(term => this.sushiService.searchSushisListByTerm(term))
      );
    }
  }
